...
class AppTestAntiguoBorrar {
    ...
    void main() {
        ...
        String expected = """
                ...
                tUPM> {class:Product, id:1, name:'Libro POO', category:BOOK, price:25.0}
                prod add: ok
                
                
                tUPM> "Agrego Camiseta"\s
                
                
                tUPM> {class:Product, id:2, name:'Camiseta talla:M UPM', category:CLOTHES, price:15.0}
                prod add: ok
                
                
                tUPM> {class:Product, id:0, name:'Camiseta talla:M UPM', category:CLOTHES, price:15.0}
                prod add: ok
                
                
                tUPM> "Listo Productos"\s
                ...
                tUPM> "Actualizo Nombre y Precio del Libro"\s
                
                
                tUPM> {class:Product, id:1, name:'Libro POO V2', category:BOOK, price:25.0}
                prod update: ok
                
                
                
                tUPM> {class:Product, id:1, name:'Libro POO V2', category:BOOK, price:30.0}
                prod update: ok
                
                
                
                tUPM> "inserto libro repetido y lo borro"\s
                
                
                tUPM> {class:Product, id:3, name:'Libro POO repetido Error', category:BOOK, price:25.0}
                prod add: ok
                ...
                tUPM> "Creo un Trabajador"\s
                
                
                tUPM> Cash{identifier='UW1234567', name='pepecurro3', email='pepe0@upm.es'}
                cash add: ok
                
                
                tUPM> Cash{identifier='UW9121937', name='pepecurro2', email='pepe0@upm.es'}
                cash add: ok
                
                
                tUPM> "Creo tres cliente listo borro uno y listo"\s
                
                
                tUPM> USER{identifier='55630667S', name='Pepe3', email='pepe1@upm.es', cash=UW1234567}
                client add: ok
                
                
                tUPM> USER{identifier='98948334B', name='Pepe2', email='pepe2@upm.es', cash=UW1234567}
                client add: ok
                
                
                tUPM> USER{identifier='Y8682724P', name='Pepe1', email='pepe3@upm.es', cash=UW1234567}
                client add: ok
                ...
                tUPM> "creo un cajero nuevo listo, lo booro y listo de nuevo"\s
                
                
                tUPM> Cash{identifier='UW1234569', name='pepecurro1', email='pepe0@upm.es'}
                cash add: ok
                ...
                tUPM> "miro los tickets de UW1234567 creo un ticket y vuelvo a printar"\s
                ...
                tUPM> Ticket : 25-12-07-22:32-47570
                  Total price: 0.0
                  Total discount: 0.0
                  Final Price: 0.0
                ticket new: ok
                ...
                tUPM> "Agrego un producto al ticket e imprimo el ticket"\s
                ...
                tUPM> Ticket : 212121-25-12-07-22:32
                  {class:Product, id:1, name:'Libro POO V2', category:BOOK, price:30.0} **discount -3.0
                  {class:Product, id:1, name:'Libro POO V2', category:BOOK, price:30.0} **discount -3.0
                  {class:Product, id:1, name:'Libro POO V2', category:BOOK, price:30.0} **discount -3.0
                  {class:Product, id:1, name:'Libro POO V2', category:BOOK, price:30.0} **discount -3.0
                ...
                tUPM> "Agrego dos productos al ticket e imprimo el ticket"\s
                ...
                tUPM> Ticket : 212123-25-12-07-22:32
                  {class:Product, id:2, name:'Camiseta talla:M UPM', category:CLOTHES, price:15.0} **discount -1.05
                  {class:Product, id:2, name:'Camiseta talla:M UPM', category:CLOTHES, price:15.0} **discount -1.05
                  {class:Product, id:2, name:'Camiseta talla:M UPM', category:CLOTHES, price:15.0} **discount -1.05
                  {class:Product, id:1, name:'Libro POO V2', category:BOOK, price:30.0} **discount -3.0
                ...
                tUPM> {class:Meeting, id:23456, name:'Reunion Rotonda', price:12.0, date of Event:2025-12-21, max people allowed:100}
                prod addMeeting: ok
                
                
                tUPM> {class:Meeting, id:23457, name:'Graduacion ETSISI', price:40.0, date of Event:2025-12-21, max people allowed:30}
                prod addMeeting: ok
                ...
                tUPM> {class:Food, id:23459, name:'Restaurante Asador', price:50.0, date of Event:2025-12-21, max people allowed:40}
                prod addFood: ok
                ...
                tUPM> Ticket : 212127-25-12-07-22:32
                  {class:Product, id:2, name:'Camiseta talla:M UPM', category:CLOTHES, price:15.0} **discount -1.05
                  {class:Product, id:2, name:'Camiseta talla:M UPM', category:CLOTHES, price:15.0} **discount -1.05
                  {class:Product, id:2, name:'Camiseta talla:M UPM', category:CLOTHES, price:15.0} **discount -1.05
                  {class:Meeting, id:23456, name:'Reunion Rotonda', price:240.0, date of Event:2025-12-21, max people allowed:100, actual people in event:20}
                ...
                tUPM> "Trabajamos con productos personalizados"\s
                
                
                tUPM> {class:ProductPersonalized, id:5, name:'Camiseta talla:M UPM', category:CLOTHES, price:15.0, maxPersonal:3}
                prod add: ok
                
                
                tUPM> {class:ProductPersonalized, id:6, name:'Camiseta talla:L UPM', category:CLOTHES, price:20.0, maxPersonal:4}
                prod add: ok
                ...
                tUPM> Ticket : 212128-25-12-07-22:32
                  {class:ProductPersonalized, id:6, name:'Camiseta talla:L UPM', category:CLOTHES, price:24.0, maxPersonal:4, personalizationList:[red, blue]} **discount -1.68
                  {class:ProductPersonalized, id:6, name:'Camiseta talla:L UPM', category:CLOTHES, price:24.0, maxPersonal:4, personalizationList:[red, blue]} **discount -1.68
                  {class:ProductPersonalized, id:6, name:'Camiseta talla:L UPM', category:CLOTHES, price:24.0, maxPersonal:4, personalizationList:[red, blue]} **discount -1.68
                  {class:ProductPersonalized, id:5, name:'Camiseta talla:M UPM', category:CLOTHES, price:15.0, maxPersonal:3} **discount -1.05
                ...
                tUPM> "Iniciamos productos servicio"\s
                
                
                tUPM> {class:ProductService, id:1, category:INSURANCE, expiration:Sun Dec 21 00:00:00 CET 2025}
                prod add: ok
                
                
                tUPM> {class:ProductService, id:2, category:TRANSPORT, expiration:Wed Dec 24 00:00:00 CET 2025}
                prod add: ok
                
                
                tUPM> "Iniciamos empresas"\s
                
                
                tUPM> COMPANY{identifier='B12345674', name='pepe2', email='pepe5@upm.es', cash=UW1234567}
                client add: ok
                ...
                tUPM> Ticket : 212129-25-12-07-22:32
                Services Included:\s
                  {class:ProductService, id:1, category:INSURANCE, expiration:Sun Dec 21 00:00:00 CET 2025}
                  {class:ProductService, id:2, category:TRANSPORT, expiration:Wed Dec 24 00:00:00 CET 2025}
                ticket print: ok
                ...
                tUPM> Ticket : 212130-25-12-07-22:32
                Services Included:\s
                  {class:ProductService, id:1, category:INSURANCE, expiration:Sun Dec 21 00:00:00 CET 2025}
                  {class:ProductService, id:2, category:TRANSPORT, expiration:Wed Dec 24 00:00:00 CET 2025}
                Product Included
