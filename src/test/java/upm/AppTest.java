...
prod addMeeting 23456 "Reunion Rotonda" 12 2025-11-21 100
prod addMeeting 23457 "Graduacion ETSISI" 40 2025-11-21 30
prod addFood 23458 "Cafeteria ETSISI" 5 2025-11-21 300
prod addFood 23459 "Restaurante Asador" 50 2025-11-21 40
prod list
...
exit
        ...
        String expected = """
                ...
                tUPM> Cash{identifier='UW8961116', name='pepecurro2', email='pepe0@upm.es'}
                cash add: ok
                
                tUPM> "Creo tres cliente listo borro uno y listo"\s
                
                tUPM> Client{identifier='55630667S', name='Pepe3', email='pepe1@upm.es', cash=UW1234567}
                client add: ok
                
                tUPM> Client{identifier='98948334B', name='Pepe2', email='pepe2@upm.es', cash=UW1234567}
                client add: ok
                
                tUPM> Client{identifier='Y8682724P', name='Pepe1', email='pepe3@upm.es', cash=UW1234567}
                client add: ok
                ...
                tUPM> Ticket : 25-11-14-18:21-92581
                  Total price: 0.0
                  Total discount: 0.0
                  Final Price: 0.0
                ticket new: ok
                ...
                tUPM> Ticket : 212121-25-11-14-18:21
                  {class:Product, id:1, name:'Libro POO V2', category:BOOK, price:30.0} **discount -3.0
                  {class:Product, id:1, name:'Libro POO V2', category:BOOK, price:30.0} **discount -3.0
                  {class:Product, id:1, name:'Libro POO V2', category:BOOK, price:30.0} **discount -3.0
                  {class:Product, id:1, name:'Libro POO V2', category:BOOK, price:30.0} **discount -3.0
                ...
                tUPM> Ticket : 212123-25-11-14-18:21
                  {class:Product, id:2, name:'Camiseta talla:M UPM', category:CLOTHES, price:15.0} **discount -1.05
                  {class:Product, id:2, name:'Camiseta talla:M UPM', category:CLOTHES, price:15.0} **discount -1.05
                  {class:Product, id:2, name:'Camiseta talla:M UPM', category:CLOTHES, price:15.0} **discount -1.05
                  {class:Product, id:1, name:'Libro POO V2', category:BOOK, price:30.0} **discount -3.0
                ...
                tUPM> {class:Meeting, id:23456, name:'Reunion Rotonda', price:0.0, date of Event:2025-11-21, max people allowed:100}
                prod addMeeting: ok
                
                tUPM> {class:Meeting, id:23457, name:'Graduacion ETSISI', price:0.0, date of Event:2025-11-21, max people allowed:30}
                prod addMeeting: ok
                
                tUPM> Error processing ->prod addFood ->Error adding product
                
                tUPM> {class:Food, id:23459, name:'Restaurante Asador', price:0.0, date of Event:2025-11-21, max people allowed:40}
                prod addFood: ok
                ...
                tUPM> Ticket : 212127-25-11-14-18:21
                  {class:Product, id:2, name:'Camiseta talla:M UPM', category:CLOTHES, price:15.0} **discount -1.05
                  {class:Product, id:2, name:'Camiseta talla:M UPM', category:CLOTHES, price:15.0} **discount -1.05
                  {class:Product, id:2, name:'Camiseta talla:M UPM', category:CLOTHES, price:15.0} **discount -1.05
                  {class:Meeting, id:23456, name:'Reunion Rotonda', price:240.0, date of Event:2025-11-21, max people allowed:100, actual people in event:20}
                ...
                tUPM> Ticket : 212128-25-11-14-18:21
                  {class:ProductPersonalized, id:6, name:'Camiseta talla:L UPM', category:CLOTHES, price:24.0, maxPersonal:4, personalizationList:[red, blue]} **discount -1.68
                  {class:ProductPersonalized, id:6, name:'Camiseta talla:L UPM', category:CLOTHES, price:24.0, maxPersonal:4, personalizationList:[red, blue]} **discount -1.68
                  {class:ProductPersonalized, id:6, name:'Camiseta talla:L UPM', category:CLOTHES, price:24.0, maxPersonal:4, personalizationList:[red, blue]} **discount -1.68
                  {class:ProductPersonalized, id:5, name:'Camiseta talla:M UPM', category:CLOTHES, price:15.0, maxPersonal:3} **discount -1.05
